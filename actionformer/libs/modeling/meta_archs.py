...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        assert backbone_type in ['convTransformer', 'conv', 'convPoolerTemporalMaxer', 'convTransformerTemporalMaxer']
        if backbone_type == 'convTransformer':
            ...
            print("Using convolutional backbone!")
            self.backbone = make_backbone(
                'conv',
                **{
                    'n_in': input_dim,
        ...
        elif backbone_type == 'convPoolerTemporalMaxer':
            print("Using TemporalMaxer backbone!")
            self.backbone = make_backbone(
                'convPoolerTemporalMaxer',
                **{
                    'n_in': input_dim,
                    'n_embd': embd_dim,
                    'n_embd_ks': embd_kernel_size,
        ...
        elif backbone_type == 'convTransformerTemporalMaxer':
            print("Using Mixed backbone!")
            self.backbone = make_backbone(
                'convTransformerTemporalMaxer',
                **{
                    'n_in' : input_dim,
                    'n_embd' : embd_dim,
                    'n_head': n_head,
