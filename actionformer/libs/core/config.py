...
DEFAULTS = {
    ...
    "model": {
        # type of backbone (convTransformer | conv | convPoolerTemporalMaxer | convTransformerTemporalMaxer)
        "backbone_type": 'convTransformerTemporalMaxer',
    ...
    "train_cfg": {
        ...
        "label_smoothing": 0.0,
        # weight parameter only for the mixed model, the higher it is the more relevance will be given to the MaxPooling branch
        "alpha": 0.5,
    },
    "test_cfg": {
